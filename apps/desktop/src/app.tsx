...
const supportedModes = sessionModeSchema.options.map((mode) =>
  mode.replace(/^./, (letter) => letter.toUpperCase()),
);
...
export function DesktopApp() {
  return (
    <AppShell
      ...
      navigation={[
        { current: true, href: '#workspace', label: 'Desktop workspace' },
      ]}
    >
      <section
        aria-labelledby="desktop-title"
        className="mx-auto grid max-w-4xl gap-6 py-8 sm:py-12"
      >
        <div className="max-w-2xl">
          ...
          <p className="mt-5 text-base leading-7 text-[var(--cl-color-muted-foreground)] sm:text-lg">
            A normal desktop view for clearer practice, structured interviews,
        ...
        <Card id="workspace">
          <CardHeader>
            ...
            <CardDescription>
              Desktop capture is not part of this application shell. No audio
              source can be selected or recorded here.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <p
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              The shared workspace is ready for the next consent-first
              milestone.
            </CardDescription>
          </CardHeader>
          <CardContent>
