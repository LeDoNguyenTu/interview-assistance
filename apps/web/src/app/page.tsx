import { Card, CardContent, CardHeader, CardTitle } from '@candorlens/ui';
      ...
      <main className="relative isolate flex-1 overflow-hidden bg-[#080808] text-[#f7f7f5]">
        ...
        <section className="relative mx-auto grid max-w-7xl gap-14 px-4 py-20 sm:px-6 sm:py-28 lg:grid-cols-[minmax(0,1.18fr)_minmax(23rem,0.82fr)] lg:items-end lg:gap-20 lg:px-8">
          <div className="max-w-3xl">
            <p className="mb-7 inline-flex min-h-8 items-center rounded-full border border-white/10 bg-white/[0.06] px-3 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-[#d8e7e1]">
              Consent-first interview workspace
            </p>
            ...
            <p className="mt-7 max-w-2xl text-base leading-7 text-[#b7b7b1] sm:text-lg sm:leading-8">
              A consent-first interview workspace for clearer practice,
              structured conversations, and evidence-oriented review.
            </p>
        ...
        <section
          className="relative border-y border-white/10 bg-[#101010]"
          id="principles"
        >
