...
select col_has_check('public', 'documents', array['storage_path', 'user_id'], 'documents constrain owner-prefixed storage paths');
...
select col_has_check('public', 'recordings', array['storage_path', 'user_id'], 'recordings constrain owner-prefixed storage paths');
...
select col_has_check('public', 'utterances', array['end_ms', 'start_ms'], 'utterances require ordered timestamps');
